...
- [dsh-token-usage](https://github.com/jiamuAi/dsh-token-usage) - Session-Gallery-style token usage panel: whole-instance cumulative/per-session peak tokens, longest chat & streak, daily/weekly/cumulative activity heatmap, and plugin/skill Top5.
