...
- [SunshineR04/dsh-session-manager](https://github.com/SunshineR04/dsh-session-manager) - Manage archived sessions from a Settings page: restore or permanently delete them, red delete item in the session context menu; open sessions delete immediately (tombstone cleanup after restart).
