...
- [DSHBox](https://github.com/WSK-build/DSHBox) - DSHBox 是一个可在安卓手机和平板上本机运行完整 DeepSeek Harness（DSH） 的app。它将 Debian、Node.js、DSH、PRoot 和 WebView 集成在一个 APK 中，无需 Root，也无需单独安装 Termux,用户安装apk即可完整体验deepseek harness.
