...
- [dsh-qwen-token-plan-cn-responses](https://github.com/nickhelion/dsh-qwen-token-plan-cn-responses) - 千问 Token Plan 个人版 Responses API 模型提供方：同步官方模型与逐模型内置工具文档，支持 DSH 本地函数和图片，并保留校验过的最近可用目录。
