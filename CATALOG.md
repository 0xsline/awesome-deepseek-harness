...
> 精选列表见 [README](README.md)；本页为公开生态全量索引（271 hub 仓库 + 988 公开 topic 仓库）
...
> 来自 GitHub 公开 [dsh-plugin Topic](https://github.com/topics/dsh-plugin)；共发现 988 个仓库，上方 hub 目录未覆盖的公开仓库列于此处。
...
| [KarlOfLaw/dsh-side-chat](https://github.com/KarlOfLaw/dsh-side-chat) | Parent-session-aware side chat plugin for DeepSeek Harness |
...
| [LoftyTao/dsh-ui-workbench](https://github.com/LoftyTao/dsh-ui-workbench) | DeepSeek Harness WebUI 的右侧边文件管理以及变更审查界面插件。 |
...
| [MoonShadow1976/chiral-pulse](https://github.com/MoonShadow1976/chiral-pulse) | 暂无描述 |
...
| [kyorakuyk/dsh-desktop](https://github.com/kyorakuyk/dsh-desktop) | 暂无描述 |
...
| [Ruler4396/dsh-launcher-lifetime](https://github.com/Ruler4396/dsh-launcher-lifetime) | DeepSeek Harness (dsh) plugin: control the dsh service lifetime (always-on / tray / follow-window) for the dsh-launcher shell |
...
| [drscrewdriver/inferglow](https://github.com/drscrewdriver/inferglow) | go 语言实现的ai 基座+ tui +server系统 |
...
| 仓库 | 描述 |
|---|---|
| [blue-a11y/dsh-client-shortcuts](https://github.com/blue-a11y/dsh-client-shortcuts) | Global keyboard shortcuts plugin for the DeepSeek Harness web GUI: ctx.shortcuts registry service + mod+l/mod+k/mod+shift+c default bindings |
...
| [mitao-su/dsh-playwright-native](https://github.com/mitao-su/dsh-playwright-native) | 把原生 Playwright CLI 注册为 DeepSeek Harness 透传工具（dsh-plugin） |
...
| [xu1132/dsh-plugin-browser](https://github.com/xu1132/dsh-plugin-browser) | A DeepSeek Harness community plugin that drives a headless Playwright browser: rendered page text, screenshots, and page automation |
...
| [Hyperionjust/Primordial-soup-](https://github.com/Hyperionjust/Primordial-soup-) | The first collision-based memory system: it doesn't retrieve old ideas — it smashes old cards into new ones. |
...
| [kerwin2046/dsh-pin-recall](https://github.com/kerwin2046/dsh-pin-recall) | DeepSeek Harness plugin: pin assistant replies and recall them into the model turn |
...
| [omdsh-dev/dsh-lark](https://github.com/omdsh-dev/dsh-lark) | Lark/Feishu IM bot channel for DeepSeek Harness: chats drive agents, replies and approvals return as messages and cards \| 飞书 DeepSeek Harness 插件 |
...
| [cesaryike/dsh-image-to-path](https://github.com/cesaryike/dsh-image-to-path) | DSH 插件:让纯文本模型对话也能拖图/贴图——图片自动保存到会话工作区,以文件路径交给模型(多模态模型不受影响) |
...
| [Isekai-Mfu/dsh-mimo-vision-hint](https://github.com/Isekai-Mfu/dsh-mimo-vision-hint) | DSH plugin: dispatch image-recognition tasks to an opencode-go mimo-v2.5 subagent via system-prompt injection |
...
| [xiaoshihou514/dsh-vision](https://github.com/xiaoshihou514/dsh-vision) | DeepSeek Harness: vision |
...
| [aryswisnu/dsh-eval-regression](https://github.com/aryswisnu/dsh-eval-regression) | 暂无描述 |
...
| [dongsheng123132/dsh-benchmark](https://github.com/dongsheng123132/dsh-benchmark) | 暂无描述 |
...
| [dongsheng123132/dsh-lineage](https://github.com/dongsheng123132/dsh-lineage) | 暂无描述 |
...
| [dongsheng123132/dsh-release-proof](https://github.com/dongsheng123132/dsh-release-proof) | 暂无描述 |
| [EvilIrving/dsh-proof](https://github.com/EvilIrving/dsh-proof) | Read-only acceptance layer for DeepSeek Harness: a verifier gates every turn and steers gaps back into the agent. |
...
| [levi-qiao/dsh-plugin-longgraph](https://github.com/levi-qiao/dsh-plugin-longgraph) | DeepSeek Harness community plugin: longgraph / loop-graph / loop-converge authoring skills on ctx.skills |
...
| [TtTRz/dsh-gatedflow](https://github.com/TtTRz/dsh-gatedflow) | Gated, durable human-in-the-loop workflow engine for DeepSeek Harness. |
...
| [NoWint/Oh-My-DSH](https://github.com/NoWint/Oh-My-DSH) | 🐋 DeepSeek Harness 插件精选集 · 300+ dsh-plugin 收录 · 22 大分类 |
...
| [PerryLink/dsh-lsp-actions](https://github.com/PerryLink/dsh-lsp-actions) | LSP action surface for DeepSeek Harness: lsp_diagnostics, lsp_format, and lsp_completion tools over language servers |
...
| [pinch-eng/dsh-audio-dub](https://github.com/pinch-eng/dsh-audio-dub) | Dub video and audio into 10 languages with voice cloning, from a DeepSeek Harness agent \| DSH 视频/音频配音插件 |
...
| [rxa3c/chat2skill](https://github.com/rxa3c/chat2skill) | Extracting and iterating skills from daily conversations with AI |
...
| [schhaohao/dsh-file-explorer](https://github.com/schhaohao/dsh-file-explorer) | dsh-file-explorer |
...
| [t1yOS/t1y-skills](https://github.com/t1yOS/t1y-skills) | expert skill package for AI coding assistants working with the t1yOS Serverless platform. |
...
| [TYEclipse/dsh-plugins-hub](https://github.com/TYEclipse/dsh-plugins-hub) | Independent plugin index for DeepSeek Harness (dsh) — curated directory of community plugins, updated daily |
...
| [YinFengWindy/dsh-plugin-shiori-role](https://github.com/YinFengWindy/dsh-plugin-shiori-role) | 暂无描述 |
...
| [1while1/dsh-whale-subagent](https://github.com/1while1/dsh-whale-subagent) | A whale-girl themed subagent nest for the DeepSeek Harness, featuring pixel-animated subagent cards, real-time THINK/TODO tracking, and a model-selectable subagent_ex tool. |
...
| [6kongbai/dsh-plugin-market](https://github.com/6kongbai/dsh-plugin-market) | A dsh plugin marketplace CLI: browse, install, and uninstall community plugins from the dsh-plugin GitHub topic |
| [acosmi/dsh-plugin](https://github.com/acosmi/dsh-plugin) | Community plugin collection for DeepSeek Harness (DSH) |
...
| [Airrcat/dsh-yuzuha-prompts-manager](https://github.com/Airrcat/dsh-yuzuha-prompts-manager) | a plugin for manage prompts in deepseek harness. |
...
| [Andy294753951/dsh-plugin-gouden-leeuw-theme](https://github.com/Andy294753951/dsh-plugin-gouden-leeuw-theme) | Unofficial Gouden Leeuw moonlit sanctuary theme for the DeepSeek Harness web UI |
...
| [cogine-ai/dsh-claude-tui](https://github.com/cogine-ai/dsh-claude-tui) | Claude Code TUI for DeepSeek Harness |
...
| [D-Robotics/dsh-plugin-rdk](https://github.com/D-Robotics/dsh-plugin-rdk) | D-Robotics RDK (地瓜机器人) integration for DeepSeek Harness — native RDK skill catalog, rdk_skills browser tool, and rdk_board_detect device detection |
...
| [duyefeng/dsh-browser](https://github.com/duyefeng/dsh-browser) | 给 DeepSeek Harness 的浏览器插件：AI 直接开真实的 Edge 浏览器逛网页、点击、填表、截图，无需 CDP 或 MCP。 |
...
| [Elohia/dsh-plugin-mm-vision](https://github.com/Elohia/dsh-plugin-mm-vision) | 暂无描述 |
...
| [Frost-Reed/blocker-notify](https://github.com/Frost-Reed/blocker-notify) | dsh-blocker-notify — Real-time attention alerts for DeepSeek Harness: a global banner + flashing workspace entries when the agent is blocked (approval request / sandbox denial). |
...
| [mengyaoi/dsh-mcp-pack](https://github.com/mengyaoi/dsh-mcp-pack) | 常用 MCP server 一键接入 DeepSeek Harness (dsh) 的 .cordis.yml 清单合集，开箱即用，零代码。 |
...
| [mingger77/research-skills](https://github.com/mingger77/research-skills) | A methodology skill for AI Agent (Claude Code) to conduct reproducible research with Python. |
...
| [nitrazepam01/dsh-web-search-tavily](https://github.com/nitrazepam01/dsh-web-search-tavily) | Tavily-backed web search provider bundle for DeepSeek Harness (dsh) with hot-switchable backend (Tavily / DeepSeek search) |
...
| [oceanxuikun/dsh-eva-theme-plugin](https://github.com/oceanxuikun/dsh-eva-theme-plugin) | Evangelion-inspired theme plugin for DSH WebUI, featuring Unit-00, Unit-01, and Unit-02 themes with immersive backgrounds and mecha-style UI effects. |
| [omdsh-dev/dsh-drag-and-drop](https://github.com/omdsh-dev/dsh-drag-and-drop) | 为 DSH Web UI 增加跨平台文件拖拽与原始路径插入能力，无需复制文件 |
...
| [peterwangze/software-project-governance](https://github.com/peterwangze/software-project-governance) | AI coding delivery trust layer for evidence-backed planning, review, risk, quality, and release control. |
| [Pheobe-Southwood/dsh-acp-paseo](https://github.com/Pheobe-Southwood/dsh-acp-paseo) | 暂无描述 |
...
| [pythonshiyi/dsh-plugin-tokenmeter](https://github.com/pythonshiyi/dsh-plugin-tokenmeter) | 词元消耗显示插件（DeepSeek Harness 网页端）：每条回复的实时词元用量 \| Per-message token usage chips for DeepSeek Harness web UI |
| [QWQ-nn/dsh-client-ui-trajectory-categories](https://github.com/QWQ-nn/dsh-client-ui-trajectory-categories) | 暂无描述 |
| [RainbowDashy/dsh-theme-palettes](https://github.com/RainbowDashy/dsh-theme-palettes) | 暂无描述 |
...
| [samecorner/dsh-token-usage](https://github.com/samecorner/dsh-token-usage) | DSH (DeepSeek Harness) web plugin — Token usage analytics tab for the conversation view (KPIs, context meter, donut, stacked per-turn bars, cumulative curve) |
...
| [tc206107/dsh-open-ecosystem](https://github.com/tc206107/dsh-open-ecosystem) | 暂无描述 |
...
| [U-Illll/dsh-memory](https://github.com/U-Illll/dsh-memory) | Memory retrieval plugin for DeepSeek Harness (dsh): wiki double-link memory graph with 9 tools — hybrid search, read, link-scan, remember, forget, compile, health-check, resident retriever subagent |
...
| [weigre/interaction-doc](https://github.com/weigre/interaction-doc) | interaction-doc · 交互文档协作开发 — 把模糊需求/PRD 交互式量产出可交付的闭环交互文档 |
...
| [wenliang9527/dsh-themes](https://github.com/wenliang9527/dsh-themes) | 暂无描述 |
...
| [xiaoheizi1212/dsh-cookie-bridge](https://github.com/xiaoheizi1212/dsh-cookie-bridge) | Chrome extension that exports plaintext cookies to dsh-computer-use over localhost (no App-Bound decryption needed). |
...
| [xuanyvne/DSHLauncher](https://github.com/xuanyvne/DSHLauncher) | DSH全程自行编写的DSH启动器，对默认的3080端口进行操作。相对于从仓库pnpm dsh web，提升一定的启动速度 |
...
| [yangl326-Dylan/learning-dsh](https://github.com/yangl326-Dylan/learning-dsh) | just learning |
| [yangyongzhen/dsh-notify](https://github.com/yangyongzhen/dsh-notify) | Task-completion notifications for DeepSeek Harness: ServerChan / DingTalk / Feishu / generic webhooks. dsh plugin. |
...
| [z21for99/silk-background](https://github.com/z21for99/silk-background) | DSH Web GUI 客户端插件：WebGL Silk 丝绸动态背景 + 全站玻璃化皮肤（官方主题 token 覆盖，零依赖） \| WebGL silk shader background & glassmorphism skin for the DeepSeek Harness Web GUI |
...
---
*Generated 2026-08-14T10:22:28Z*