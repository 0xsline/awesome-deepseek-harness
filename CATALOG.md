...
> 汇集 [dsh-external/hub](https://github.com/dsh-external/hub) 的 `catalog.json` 与 GitHub 公开 [dsh-plugin Topic](https://github.com/topics/dsh-plugin) 的全量生态索引 · 生成于 2026-08-14
...
| [Ayase34/gal-view](https://github.com/Ayase34/gal-view) | 暂无描述 |
...
| [chajiuqqq/dsh-claude-theme](https://github.com/chajiuqqq/dsh-claude-theme) | dsh的claude风格界面 |
...
| [czzzlq/deepseek-harness-background](https://github.com/czzzlq/deepseek-harness-background) | deepseek-harness背景自定义 |
...
| [Jinsong-Zhou/dsh-html-canvas](https://github.com/Jinsong-Zhou/dsh-html-canvas) | A DeepSeek Harness plugin that turns AI-generated HTML into a click-to-edit canvas beside the chat |
...
| [longyu065/dsh-theme-ti](https://github.com/longyu065/dsh-theme-ti) | 暂无描述 |
| [lynkas/dsh-think-flow-flow](https://github.com/lynkas/dsh-think-flow-flow) | DeepSeek Harness client plugin: constant-rate typewriter reveal for assistant output and reasoning, with per-model gating. |
...
| [NigelYao/dsh-view-modes](https://github.com/NigelYao/dsh-view-modes) | view modes for deepseek harness, including Verbose, Normal, Summary Mode |
...
| [Shmilyol/galgame-skin](https://github.com/Shmilyol/galgame-skin) | 暂无描述 |
| [Simon314620/dsh-turn-index](https://github.com/Simon314620/dsh-turn-index) | deepseek harness的侧边栏对话轮次索引插件 |
...
| [xing-shuyin/ds-web-ui](https://github.com/xing-shuyin/ds-web-ui) | My DeepSeek Harness Web UI |
...
| 仓库 | 描述 |
|---|---|
| [15828148/dsh-portable-launcher](https://github.com/15828148/dsh-portable-launcher) | One-click portable launcher for DeepSeek Harness (dsh) Web UI on Windows. Auto-installs Node.js and dsh with China mirror fallback, 3-stage progress with retries and resume, zero-download fast path when ready. No admin needed. |
...
| [czzzlq/deepseek-harness-desktop](https://github.com/czzzlq/deepseek-harness-desktop) | deepseek-harness-desktop / deepseek-harness桌面端 |
...
| [rabbitknight/dsh-tui](https://github.com/rabbitknight/dsh-tui) | DeepSeek HarnessTerminal UI. |
| [xiaoshihou514/dsh-tui](https://github.com/xiaoshihou514/dsh-tui) | DeepSeek Harness: TUI |
...
| [BrambleXu/dsh-prompt-profile](https://github.com/BrambleXu/dsh-prompt-profile) | Reusable Markdown prompt profiles for DeepSeek Harness with per-turn model selection, argument substitution, and state restoration. DeepSeek Harness 可复用 Markdown Prompt Profile，支持单轮模型选择、参数替换和状态恢复。 |
...
| [PerryLink/dsh-composer-history](https://github.com/PerryLink/dsh-composer-history) | Terminal-style input history for the DeepSeek Harness web composer - edge-first arrow keys, draft stashing with exact restore, Esc recovery. A dsh-plugin. |
...
| [CrazyShout/dsh-ssh-remote](https://github.com/CrazyShout/dsh-ssh-remote) | SSH remote workspaces for DeepSeek Harness: browse/read/write remote files, run remote commands, with connection status dots. |
...
| [MashedPotato817/dsh-tool-browser](https://github.com/MashedPotato817/dsh-tool-browser) | Native browser automation tools for DeepSeek Harness, powered by Playwright + Edge |
...
| [tanf1ng/dsh-tool-hackernews](https://github.com/tanf1ng/dsh-tool-hackernews) | Hacker News tool suite (hn_top_stories, hn_search, hn_item) for DeepSeek Harness agents |
...
| [dpskh/dsh-checkpoint](https://github.com/dpskh/dsh-checkpoint) | Mark an exploration start in the session; pairs with rewind to fold the exploration out of context. |
| [dpskh/dsh-rewind](https://github.com/dpskh/dsh-rewind) | Fold everything since the last checkpoint mark into an auto-generated report, replacing it in context while keeping the full log. |
...
| [modusensus/dsh-mneme](https://github.com/modusensus/dsh-mneme) | Mneme——把记忆主权还给人的记忆插件：SQLite + 可人工编辑的 Markdown 双写，autoDream 在梦境中巩固记忆，140 个测试护航。 |
...
| [Spirtxiaoqi7/mindspace-dsh-session-memory](https://github.com/Spirtxiaoqi7/mindspace-dsh-session-memory) | Editable, session-isolated personalization memory for DeepSeek Harness |
...
| [wly8691-jpg/knowlp-rag](https://github.com/wly8691-jpg/knowlp-rag) | KnowLP-RAG: dual knowledge graph retrieval for Markdown notes - MCP stdio server for DeepSeek Harness (dsh) & Claude Code |
...
| [STARDUSTLC666/dsh-dingtalk](https://github.com/STARDUSTLC666/dsh-dingtalk) | 暂无描述 |
| [STARDUSTLC666/dsh-email](https://github.com/STARDUSTLC666/dsh-email) | DeepSeek Harness 邮件插件：email_list/read/search/send/folders/attachment 六工具，内置 QQ/163/126/新浪/阿里/Gmail/Outlook/iCloud 八个预设，多账号、附件收发、Web 设置页配置，纯 Node 全平台。 |
| [STARDUSTLC666/dsh-slack](https://github.com/STARDUSTLC666/dsh-slack) | 暂无描述 |
...
| [akqwpeter-prog/dsh-media-skills](https://github.com/akqwpeter-prog/dsh-media-skills) | Free image reading & generation for DeepSeek Harness — paste an image into any chat, even text-only sessions. 免费读图·生图 · 9 种语言 · 无 Key 入库 |
...
| [Elohia/pi-mm-vision](https://github.com/Elohia/pi-mm-vision) | Synesthesia Encoder (通感编码器) — give any text-only LLM (DeepSeek, etc.) the ability to see images via structured spatial text encoding. A Pi agent extension. |
...
| [hawkongz/doubao-vision-dsh](https://github.com/hawkongz/doubao-vision-dsh) | 让纯文本模型通过桌面豆包看见聊天图片的 DeepSeek Harness 宿主插件(CDP 桥接,全预设生效,识别可取消) |
...
| [Xieweikang123/dsh-vision-bridge](https://github.com/Xieweikang123/dsh-vision-bridge) | Give a text-only dsh model eyes: pasted images recognized into text via an OpenAI-compatible vision endpoint. |
...
| [Yuuz12/dsh-vision-helper](https://github.com/Yuuz12/dsh-vision-helper) | DeepSeek Harness Vision Helper/DeepSeek Harness 视觉辅助方案 |
...
| [emredeveloper/deepseek-harness-huggingface](https://github.com/emredeveloper/deepseek-harness-huggingface) | A community DeepSeek Harness plugin for read-only Hugging Face Hub model discovery. |
...
| [MirDie/dsh-xai](https://github.com/MirDie/dsh-xai) | xAI Grok SuperGrok / X Premium OAuth for DeepSeek Harness |
...
| [Tokimorphling/tokilake-ai-gateway](https://github.com/Tokimorphling/tokilake-ai-gateway) | Self-hosted AI gateway for distributed local LLM GPUs. OpenAI-compatible API with NAT traversal, WebSocket/QUIC tunnels, Ollama/vLLM/SGLang workers. |
...
| [FantasyStarry/dsh-token-stats](https://github.com/FantasyStarry/dsh-token-stats) | 暂无描述 |
...
| [hnmrxz/dsh-plugin-usage-dashboard](https://github.com/hnmrxz/dsh-plugin-usage-dashboard) | DeepSeek usage & cost dashboard for the DSH bottom status bar: per-session token/cost aggregation with low-balance budget alert. |
...
| [Wanbinyu/dsh-billing](https://github.com/Wanbinyu/dsh-billing) | 暂无描述 |
...
| [xinmo114514/dsh-usage-widget](https://github.com/xinmo114514/dsh-usage-widget) | DSH (DeepSeek Harness) 持久化 Web 插件：Token 用量统计悬浮窗 —— 可拖动窗口/圆点、曲线/热力图、总 tokens 大数字；宿主半聚合会话日志并提供 /usage/api/snapshot |
...
| [hnmrxz/dsh-plugin-sysmon](https://github.com/hnmrxz/dsh-plugin-sysmon) | Local system resource monitor (CPU / memory / disk / load / uptime) for the DeepSeek Harness bottom status bar. |
...
| [EvilIrving/dsh-repro](https://github.com/EvilIrving/dsh-repro) | Minimal, secret-scrubbed, replayable problem bundles for DeepSeek Harness sessions (/repro). |
...
| [Porphyrioon/ironlaw](https://github.com/Porphyrioon/ironlaw) | IronLaw: evidence-backed completion and repair layer for coding agents |
...
| [qing3a/dsh-plugin-verify](https://github.com/qing3a/dsh-plugin-verify) | 验证 DSH 插件的 CLI：一条命令跑 mock-llm 完整 agent 循环，检查 waterfall 链与零副作用，产出验证报告 |
...
| [PerryLink/dsh-skill-pack-security](https://github.com/PerryLink/dsh-skill-pack-security) | Security-audit skill pack for DeepSeek Harness (dsh): 5 agent skills - secret scan, dependency audit, supply-chain review, prompt-injection review, audit orchestration. Zero runtime code. Apache-2.0. |
...
| [Beants/dsh-trellis](https://github.com/Beants/dsh-trellis) | 暂无描述 |
...
| [csiroqa/dsh-schedule](https://github.com/csiroqa/dsh-schedule) | DeepSeek Harness（DSH）定时任务 + 状态监控插件：按 cron 时间表自动触发 Agent 执行任务，/status 与设置页仪表盘查看系统与 harness 综合状态。Scheduled tasks (cron) + status monitoring plugin for DeepSeek Harness. |
...
| [songqikong/dash](https://github.com/songqikong/dash) | DASH — Deepseek Agentic Service Harness |
...
| [anweat/dsh-plugin-dev-guide](https://github.com/anweat/dsh-plugin-dev-guide) | DSH (DeepSeek Harness) plugin development & publishing guide: from first plugin to auto-publish to the community |
...
| [BrambleXu/dsh-revdiff](https://github.com/BrambleXu/dsh-revdiff) | Native interactive Git diff review for DeepSeek Harness with structured annotations sent back to the current Agent session. DeepSeek Harness 原生交互式 Git diff 审查，支持结构化批注并回传当前 Agent 会话。 |
...
| [dsh-plugin/dsh-plugin.github.io](https://github.com/dsh-plugin/dsh-plugin.github.io) | DeepSeek Harness community plugin workshop and directory |
...
| [hellodigua/dsh-share](https://github.com/hellodigua/dsh-share) | DSH 对话分享插件，一键分享你的对话。One-click conversation sharing for DSH. |
...
| [jihongboo/dsh-apple-mode](https://github.com/jihongboo/dsh-apple-mode) | Xcode AI integration mode for DeepSeek Harness (dsh) — an agent preset + installer that gives your DSH sessions the full Xcode AI stack. |
...
| [kalynnka/vscode-deepseek-harness](https://github.com/kalynnka/vscode-deepseek-harness) | Unofficial: drive your own DeepSeek Harness (dsh) as a native VS Code chat agent, beside Claude Code and Codex. |
...
| [like-study1/Oh-My-DSH](https://github.com/like-study1/Oh-My-DSH) | 🐳 DeepSeek Harness 插件聚合社区 — 自动同步 dsh-plugin 生态 · 精选目录 · 每 8 小时自动维护 \| Oh-My-DSH: a community-maintained catalog of DeepSeek Harness plugins, auto-synced from the dsh-plugin topic |
...
| [mouliangyu/dsh-plugins](https://github.com/mouliangyu/dsh-plugins) | Community plugins for DeepSeek Harness |
...
| [ophielel/dsh-devkit](https://github.com/ophielel/dsh-devkit) | 暂无描述 |
...
| [Scorp1o117/dsh-plugin-marketplace](https://github.com/Scorp1o117/dsh-plugin-marketplace) | Plugin marketplace for DeepSeek Harness \| DeepSeek Harness 插件市场 |
...
| [skitse/dsh-dev-actions](https://github.com/skitse/dsh-dev-actions) | AI turns repeated dev commands, prompts, and habits into one-click DeepSeek Harness actions. |
...
| [STARDUSTLC666/dsh-calendar](https://github.com/STARDUSTLC666/dsh-calendar) | 暂无描述 |
...
| [ZASENJC/dsh-plugins-store](https://github.com/ZASENJC/dsh-plugins-store) | 自动收录和分类 GitHub dsh-plugin Topic 项目的静态目录网站 |
| [ZBCs-StudioCr-CN/dsh-skill-manager](https://github.com/ZBCs-StudioCr-CN/dsh-skill-manager) | 暂无描述 |
...
| [hellodigua/dsh-emoji](https://github.com/hellodigua/dsh-emoji) | 让 AI 回复加入自定义表情 |
...
| [Leawind/dsh-minecraft-dev](https://github.com/Leawind/dsh-minecraft-dev) | 一个面向 Minecraft 模组开发的 DeepSeek Harness Agent 预设 |
...
| [Scorp1o117/dsh-soul-md](https://github.com/Scorp1o117/dsh-soul-md) | Soul.md persona for DeepSeek Harness \| DeepSeek Harness 人设卡插件 |
...
| [yuxino/dsh-blue-whale-maid](https://github.com/yuxino/dsh-blue-whale-maid) | dsh web 的桌面宠物插件，本质是一个任务完成提醒器。 |
...
| [1514100951/dsh-notify-plugins](https://github.com/1514100951/dsh-notify-plugins) | DeepSeek Harness desktop notification plugins: browser + native Windows toasts on task finish/error, blocking waits (approval/question/plan-review), and background job settlement |
...
| [Alexis-fish/dsh-worktrees](https://github.com/Alexis-fish/dsh-worktrees) | Git worktree isolation for parallel DeepSeek Harness sessions |
| [Aloneswork/deepseek-harness-codex-bridge](https://github.com/Aloneswork/deepseek-harness-codex-bridge) | Codex 主导、DeepSeek Harness 辅助的本地双向 MCP 协作桥｜Local bidirectional Codex ↔ DSH MCP bridge |
...
| [anywhere-labs/deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | 基于官方 DeepSeek Harness 打造的 Electron 桌面端，深度适配 macOS 和 Windows，提供最佳的，开箱即用的体验。 |
...
| [arrow949/dsh-turn-approval](https://github.com/arrow949/dsh-turn-approval) | Turn-scoped "Allow for this task" approvals for DeepSeek Harness. |
...
| [AtlasCloudAI/cli](https://github.com/AtlasCloudAI/cli) | AtlasCloud CLI installers and release artifacts |
...
| [Babulubobo/dsh-codex-oauth](https://github.com/Babulubobo/dsh-codex-oauth) | use your codex subscription in deepseek harness |
| [baidd1011/dsh-code-impact](https://github.com/baidd1011/dsh-code-impact) | 面向 DeepSeek Harness 的只读 TypeScript/JavaScript 代码变更影响分析插件 Read-only TypeScript/JavaScript change impact analysis plugin for DeepSeek Harness |
...
| [beex-labs/dsh-desktop-plugin](https://github.com/beex-labs/dsh-desktop-plugin) | dsh-desktop-plugin |
...
| [benzhoupo/dsh-dardar](https://github.com/benzhoupo/dsh-dardar) | DSH 插件：在模型选择框左侧显示当前 DeepSeek V4 Pro / V4 Flash 的 codexradar IQ，每 5 分钟刷新（CC BY 4.0） |
...
| [bluecobaltum/dsh-lan-proxy](https://github.com/bluecobaltum/dsh-lan-proxy) | 暂无描述 |
...
| [bowenliang123/dsh-context](https://github.com/bowenliang123/dsh-context) | A DeepSeek Harness plugin for  Context insight panel — a Context tab in the web UI showing what the model's context window is made of and how it evolves. |
...
| [ByronLeeeee/dsh-legal-dashboard](https://github.com/ByronLeeeee/dsh-legal-dashboard) | Matter-aware legal workspace dashboard and document agent tools for DeepSeek Harness |
...
| [caopu16/dsh-llm-kiro](https://github.com/caopu16/dsh-llm-kiro) | deepseek-harness 的插件，可以使用kiro的模型（claude系列）和账号 |
| [Ceelog/dsh-plugins](https://github.com/Ceelog/dsh-plugins) | deepseek harness plugins |
| [chancelu/dsh-llmwiki](https://github.com/chancelu/dsh-llmwiki) | Local Markdown wiki as long-term memory for DeepSeek Harness — RRF-fused retrieval (keyword + wikilink graph + temporal), token-budget injection, auto-capture. Ported from llmwiki. |
...
| [chenw2759-wq/dsh-easyssh](https://github.com/chenw2759-wq/dsh-easyssh) | 这是一个ssh前端程序，可以让UI体现类似lab的功能！用于远程ssh快速相应，同时可以直接在前端操作/查看远程服务器上的信息与代码。 |
...
| [CriscolTheCoder/dsh-plugin-browser](https://github.com/CriscolTheCoder/dsh-plugin-browser) | 暂无描述 |
...
| [DGPisces/deepseek-harness-openai-oauth](https://github.com/DGPisces/deepseek-harness-openai-oauth) | DeepSeek Harness provider for GPT models using managed ChatGPT OAuth through Codex app-server |
...
| [djasdh/interest-memory](https://github.com/djasdh/interest-memory) | Low-footprint memory backend for AI agents — single binary, ~50MB RAM, verify-augmented accuracy |
...
| [dylan121322/llm-adaptive](https://github.com/dylan121322/llm-adaptive) | 暂无描述 |
...
| [ethanweave/glm4v-vision-mcp](https://github.com/ethanweave/glm4v-vision-mcp) | GLM-4.6V 图像理解 MCP：识图/OCR/图表解析，原生接入 DeepSeek Harness（dsh-mcp-client），也兼容 Codex/Cline 等 |
...
| [fryghost/deepseek-eyes](https://github.com/fryghost/deepseek-eyes) | Community plugin for DeepSeek Harness: give text-only models eyes - paste images natively, described via an OpenAI-compatible vision API |
...
| [fzlong/dsh-balance-eta](https://github.com/fzlong/dsh-balance-eta) | DeepSeek Harness 极简余额插件：余额 + 今日消耗 + 可用时长预测 + 低余额告警（仅 CNY，价格无关免维护） |
| [Gandufu/dsh-plugin](https://github.com/Gandufu/dsh-plugin) | DeepSeek Harness 插件集合｜齐天大圣双主题皮肤，支持亮暗模式、响应式布局与热插拔 |
...
| [hahaha-taotao/dsh-oauth-api](https://github.com/hahaha-taotao/dsh-oauth-api) | DeepSeek Harness (dsh) out-of-tree OAuth plugin for Grok/xAI, Codex, and Claude Code. Community plugin, not official. |
| [haiyoucuv/dsh-model-provider-label](https://github.com/haiyoucuv/dsh-model-provider-label) | DeepSeek Harness plugin that disambiguates same-named models by showing their provider |
...
| [hellosky983/dsh-skillradar](https://github.com/hellosky983/dsh-skillradar) | Skill Radar for DeepSeek Harness (dsh): scan the current session's visible skills, score relevance against the conversation, and recommend which skill to load. |
| [hellosz/dsh-pets](https://github.com/hellosz/dsh-pets) | 暂无描述 |
...
| [Hilbert-beinghappy/deepseek-tui](https://github.com/Hilbert-beinghappy/deepseek-tui) | Pluggable DeepSeek-colored TUI for DeepSeek Harness |
...
| [imtheolin/ai-keyboard](https://github.com/imtheolin/ai-keyboard) | Putting prompts at your fingertips |
...
| [je00/dsh-codex-agent-bridge](https://github.com/je00/dsh-codex-agent-bridge) | Use the Codex models included with your ChatGPT subscription directly in DeepSeek Harness—no API key or separate API billing. |
...
| [jonah791/dsh-agent-compact](https://github.com/jonah791/dsh-agent-compact) | Agent-driven compaction for DeepSeek Harness: the agent summarizes its own conversation (KV-cache friendly, no giant replay). Verified in production at ~460k-token sessions. |
| [juhe291/dsh-token-panel](https://github.com/juhe291/dsh-token-panel) | Real-time token consumption HUD plugin for DeepSeek Harness. Live token usage monitor, context pressure, cost estimation, history curves, per-day/per-month stats. DeepSeek Harness 实时 Token 消耗监控插件：用量统计、成本估算、趋势曲线、按日按月报表。 |
| [JuneLearn/dsh-reasoning-settings](https://github.com/JuneLearn/dsh-reasoning-settings) | 为 DeepSeek Harness 自定义供应商提供推理强度设置与按次调用的子 Agent 模型路由｜Reasoning effort settings and per-call subagent model routing for DeepSeek Harness custom providers |
...
| [Kristin130/dsh-commandcode-provider](https://github.com/Kristin130/dsh-commandcode-provider) | dsh LLM provider plugin for Command Code — every plan incl. Go, uses your Studio API key over /alpha/generate |
...
| [LAN-TINA-WS/dsh-gui-customization](https://github.com/LAN-TINA-WS/dsh-gui-customization) | DeepSeek Harness 时装工坊：给 DSH 界面换装——Nous 蓝配色 / 氛围光 / 背景图预设，中英双语 · The fashion workshop for DSH Web UI. |
...
| [LeslieWylie/dsh-benchmark-evidence](https://github.com/LeslieWylie/dsh-benchmark-evidence) | Benchmark manifests, fail-closed gates, artifact contracts, and result integrity skills for DeepSeek Harness. |
| [LeslieWylie/dsh-memory-evidence](https://github.com/LeslieWylie/dsh-memory-evidence) | Git-first memory navigation and bounded evidence tools for DeepSeek Harness. |
...
| [LeslieWylie/dsh-ops-kit-legacy](https://github.com/LeslieWylie/dsh-ops-kit-legacy) | Archived: evidence-driven memory, multi-agent orchestration, benchmark, and plugin-release tools for DeepSeek Harness. Superseded by dsh-ops-kit. |
...
| [LiangYin233/dsh-provider-model-configurator](https://github.com/LiangYin233/dsh-provider-model-configurator) | DSH 高级模型配置器：为 DeepSeek Harness 提供将 pi-ai 预设模型的上下文、输出上限、推理挡位一键应用到自定义提供商的能力。 |
...
| [linqunxun/dsh-plugins](https://github.com/linqunxun/dsh-plugins) | Money go brrr — DSH client UI plugins collection |
...
| [ljcscp/dsh-session-cost](https://github.com/ljcscp/dsh-session-cost) | Session cost & balance readout for DeepSeek Harness (DSH) Web GUI: official pricing, peak/off-peak hours, per-model costing |
...
| [loki888666/dsh-mihome](https://github.com/loki888666/dsh-mihome) | 暂无描述 |
...
| [lsz-asd/dsh-chameleon](https://github.com/lsz-asd/dsh-chameleon) | 暂无描述 |
...
| [LvienOeria/dsh-desktop-launcher](https://github.com/LvienOeria/dsh-desktop-launcher) | 一个轻量的 dsh（DeepSeek Harness）插件：安装桌面双击启动器 —— macOS 上是带官方鲸鱼图标的 dsh.app，Linux 上是 .desktop 入口。零依赖，约 147 KB。（终端命令在独立的 dsh-launcher 包） |
...
| [ly6170/dsh-messager](https://github.com/ly6170/dsh-messager) | 基于Deepseek Harness+DeepSeek开发的适用于Deepseek Harness的消息提醒信使，可使用第三方通道（暂时飞书webhook）进行推送 |
...
| [meme-dog/dsh-plugin-finder](https://github.com/meme-dog/dsh-plugin-finder) | Find and audit DeepSeek Harness (DSH) plugins inside the agent — live `dsh-plugin` topic search + source audit with trial-to-production install plans. |
| [miaobuao/dsh-document-parser](https://github.com/miaobuao/dsh-document-parser) | A DeepSeek Harness document parsing tool powered by LiteParse |
...
| [mtaech/dsh-material-you](https://github.com/mtaech/dsh-material-you) | Material You (M3) skin for DeepSeek Harness: HCT tonal palette + Maple Mono NF CN, clean blue & white |
...
| [NaNExist/dsh-win-launchscript](https://github.com/NaNExist/dsh-win-launchscript) | 适用于 Windows 的 DeepSeek Harness（DSH）一键启动脚本，自动启动 Web 服务、打开浏览器，并在关闭窗口后停止服务。 |
...
| [o-Sakurajimamai-o/dsh-desktop](https://github.com/o-Sakurajimamai-o/dsh-desktop) | DeepSeek Harness Desktop/App |
...
| [oxygenaaaaa/dsh-desktop](https://github.com/oxygenaaaaa/dsh-desktop) | DeepSeek Harness as a Windows desktop app — one-click install, ready to use |
...
| [ParticleLight/dsh-ultracode](https://github.com/ParticleLight/dsh-ultracode) | 暂无描述 |
...
| [phoenixlucky/chrome-mcp-bridge-2026-skill](https://github.com/phoenixlucky/chrome-mcp-bridge-2026-skill) | 为 AI 代理提供稳定可靠的 Streamable HTTP MCP 连接能力 |
...
| [pineapple880066/dsh-webUI-pets](https://github.com/pineapple880066/dsh-webUI-pets) | Codex-style desktop pets for the DeepSeek Harness Web UI / 类似 Codex 的 DeepSeek Harness Web UI 桌宠 |
| [pjy-20051012/dsh-file-preview](https://github.com/pjy-20051012/dsh-file-preview) | 暂无描述 |
| [poiuyjie/dsh-vision-opencode](https://github.com/poiuyjie/dsh-vision-opencode) | 暂无描述 |
| [pythonshiyi/dsh-plugin-balance](https://github.com/pythonshiyi/dsh-plugin-balance) | 余额显示插件（DeepSeek Harness 网页端）：会话头部实时账户余额 \| Live account balance for DeepSeek Harness web UI |
| [QWQ-nn/dsh-client-ui-trajectory-categories](https://github.com/QWQ-nn/dsh-client-ui-trajectory-categories) | 暂无描述 |
...
| [RayYeung1989/claude-parchment-theme](https://github.com/RayYeung1989/claude-parchment-theme) | 一款 Claude 风格的 dsh插件：为 DSH WebUI 打造，暖羊皮纸 Parchment 色板、Terracotta 品牌色与衬线字体 |
...
| [revive/dsh-git-credentials](https://github.com/revive/dsh-git-credentials) | DeepSeek Harness plugin: GitLab and GitHub API tokens stay out of the model context — encrypted at rest (AES-256-GCM), tools on demand, web settings panel. |
...
| [shaoyi1991/dsh-restart-web](https://github.com/shaoyi1991/dsh-restart-web) | DSH Web 设置页新增的「重启」入口：点击即可安全重启整个 DSH 进程，页面约 5 秒后自动重新连接。 |
| [showlibia/dsh-plugin-installer](https://github.com/showlibia/dsh-plugin-installer) | 暂无描述 |
| [Sikao-Engine/KimiX](https://github.com/Sikao-Engine/KimiX) | The next-gen lightweight coding agent cli |
| [silencieuxzero/Better_Deepseek_Harkness](https://github.com/silencieuxzero/Better_Deepseek_Harkness) | 更好的deepseek harness，为webui进行了一些拓展 |
| [skr311/dsh-codex-pet](https://github.com/skr311/dsh-codex-pet) | dsh-codex-pet · DSH 桌面宠物插件 — 导入精灵图序列帧宠物，悬浮浮层渲染 + Agent 状态联动 |
| [Slowdownnn/dsh-read-history](https://github.com/Slowdownnn/dsh-read-history) | 迁移claude/codex的对话历史到dsh |
...
| [SPYQWER1/dsh-imagecraft](https://github.com/SPYQWER1/dsh-imagecraft) | 暂无描述 |
| [Sqhao-O/dsh-docling](https://github.com/Sqhao-O/dsh-docling) | Native Docling document intelligence for DeepSeek Harness. |
| [stevenx65/dsh-balance-plugin](https://github.com/stevenx65/dsh-balance-plugin) | 暂无描述 |
| [studyzy/dsh-lazy-tools](https://github.com/studyzy/dsh-lazy-tools) | 暂无描述 |
...
| [TableRogue/dsh-message-navigator](https://github.com/TableRogue/dsh-message-navigator) | 消息导航条 Message Navigator: DeepSeek Harness 网页聊天界面右侧的垂直消息索引(动态 Cordis 插件) |
...
| [tiefeiyu/dsh-see-image](https://github.com/tiefeiyu/dsh-see-image) | A see_image vision tool plugin for DeepSeek Harness — describe images through any OpenAI-compatible vision model (GitHub Copilot, OpenAI, Ollama, vLLM, LM Studio). |
...
| [TT-Wang/dsh-assembler](https://github.com/TT-Wang/dsh-assembler) | 暂无描述 |
...
| [w1661884010-jpg/dsh-plugin-github-market](https://github.com/w1661884010-jpg/dsh-plugin-github-market) | DSH web client plugin: browse GitHub dsh-plugin topic repositories (fuzzy search, sort, favorites, install-command copy, optional token) |
...
| [weinibuliu/deepseek-harness-vsc-extension](https://github.com/weinibuliu/deepseek-harness-vsc-extension) | DeepSeek Harness for VS Code |
...
| [Whning0513/deepseek-protocol-doctor](https://github.com/Whning0513/deepseek-protocol-doctor) | Checks DeepSeek tool loops, reasoning_content, strict schemas, and captured SSE. Also works as a DSH plugin. |
...
| [wuxiaoji/Dsh_Desktop](https://github.com/wuxiaoji/Dsh_Desktop) | Dsh_Desktop is a desktop version of deepseek-harness packaged in Rust, which is designed to be easy for beginners to install, use and update. No modifications have been made to the dsh code. |
...
| [XDzzzzzZyq/dsh-survival](https://github.com/XDzzzzzZyq/dsh-survival) | DeepSeek Harness 生存模式 |
...
| [xiaoheizi1212/dsh-computer-use](https://github.com/xiaoheizi1212/dsh-computer-use) | Model-agnostic Computer Use for DeepSeek Harness: isolated browser, Windows native helper, third-party vision perception, and a Chrome Cookie Bridge. |
| [XJungit/omdp](https://github.com/XJungit/omdp) | only my DSH plugins — monorepo of DeepSeek Harness plugin bundles |
| [xluomo/dsh-mcp-settings](https://github.com/xluomo/dsh-mcp-settings) | dsh mcp服务器配置管理 |
...
| [yan5236/slcatwujian-dsh-vision-plugin](https://github.com/yan5236/slcatwujian-dsh-vision-plugin) | 让不支持图片输入的主模型通过已配置的视觉模型理解图片的 DSH 插件：自动桥接、像素坐标描述、vision_ask 追问工具与设置页 |
...
| [Ye-Yu-Mo/dsh-llm-proxy](https://github.com/Ye-Yu-Mo/dsh-llm-proxy) | DeepSeek Harness (dsh) 全局 HTTP 代理插件：undici setGlobalDispatcher + EnvHttpProxyAgent，配置化、热切换、可观测 |
...
| [ylouis8/kph](https://github.com/ylouis8/kph) | 基于dsh的量化研究agent，驱动真实回测与交易。 |
| [YohtHill/dsh-plugin-greeter](https://github.com/YohtHill/dsh-plugin-greeter) | A DeepSeek Harness (dsh) plugin that greets you at the start of every session with varied wording, and remembers your name. |
| [Yuel25/dsh-desktop](https://github.com/Yuel25/dsh-desktop) | A Windows desktop client for DeepSeek Harness. |
| [Yugitan/dsh-skin](https://github.com/Yugitan/dsh-skin) | Customizable skinning plugin for DeepSeek Harness Web UI — gradient presets, image wallpapers, translucency, accent colors, persisted in user settings |
| [yuko0331/DSH-telegram](https://github.com/yuko0331/DSH-telegram) | 通过 Telegram 私聊远程使用和查看 DeepSeek Harness |
| [Yummyxl/dsh-eyecare](https://github.com/Yummyxl/dsh-eyecare) | dsh护眼插件 |
...
| [zealot00/dsh-zen](https://github.com/zealot00/dsh-zen) | Zen mode for DeepSeek Harness Web UI: one-click immersive focus (hide sidebar/topbar), Ctrl+Shift+Z, pet auto-hide linkage |
...
| [zimai233/dsh-figma-to-lottie](https://github.com/zimai233/dsh-figma-to-lottie) | Figma/SVG to Lottie animation compiler for DeepSeek Harness. Turn SVG paths and keyframe data into self-contained .lottie.json files. |
...
---
*Generated 2026-08-14T12:24:11Z*